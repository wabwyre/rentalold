...
var App = function () {
    ...
    return {
        ...
        blockUI: function (el) {
            ...
            if ( url.indexOf('app_dev.php')>=0 ) url = url.substring(0, url.indexOf('app_dev.php'));
            else if ( url.indexOf('app.php')>=0 ) url = url.substring(0, url.indexOf('app.php'));
            else url = '/';
            
            jQuery(el).block({
                message: '<img src="'+url+'oriems-live/assets/img/loading.gif" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
