var FormComponents = function () {
    ...
    var handleSelec2 = function () {
        ...
        $('#select2_sample3').select2({
            placeholder: "Select a Revenue Channel",
            allowClear: true
        });
        ...
        $('#select2_sample13').select2({
            placeholder: "Select a Service Channel",
            allowClear: true
        });

        $('#select2_sample14').select2({
            placeholder: "Select a Service Channel",
            allowClear: true
        });

        $('#select2_sample21').select2({
            placeholder: "Select a Revenue Channel",
            allowClear: true
        });

        $('#select2_sample22').select2({
            placeholder: "Select a Revenue Channel",
            allowClear: true
        });

         $('#select2_sample23').select2({
