                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div>' +
                      ...
                      '<input class="input-mini" type="text" id="from_date" name="daterangepicker_start" value="" disabled="disabled" />' +
                    '</div>' +
                    '<div>' +
                      '<label for="daterangepicker_end">' + this.locale.toLabel + '</label>' +
                      '<input class="input-mini" id="to_date" type="text" name="daterangepicker_end" value="" disabled="disabled" />' +
                    '</div>' +
                    '<button id="submit_date_range" class="btn btn-small" disabled="disabled">' + this.locale.applyLabel + '</button>' +
                  '</div>' +
                '</div>' +
              '</div>';
