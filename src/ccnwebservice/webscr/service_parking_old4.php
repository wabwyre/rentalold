<?
	...
	$descr = explode("*",$description); //transaction_code * option_code * inputs * agentcode * email * phone 
	echo "<hr>".$description;
	...
	echo "<hr>Inputs[".$total_inputs."] == AgentIndex[".$agent_index."] == AgentCode[".$agent_code."] == Phone[".$phone."] == Email[".$email."]<hr>";
