<?
	...
	*************************************************************************************************************/
	...
	if($_POST['TRANSACTIONCODE'])
	{
		...
		traceActivity("..=POST=$trans_code=$service_code=$user_account=$description=$amount=$date_logged");		
	}
	else
	{
		...
		traceActivity("..=HEADERS=$trans_code=$service_code=$user_account=$description=$amount=$date_logged");	
	}
/************************************************************************************************************
