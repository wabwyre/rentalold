<?
	...
	$agent_id = 4;//getAgentIDByCode($agent_code);  //3rd party agent
	$paid_amt = 140;//$amount; //amount paid to the third party...
	...
	$phone = "0720810193";//$descr[2]; //customer phone number
	$email = $descr[3]; //customer email address
