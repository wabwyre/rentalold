<?
		...
		/*Email Username and password to new member*/
			...
			$content = "<table width='408' border='0'>
						 ...
						 <tr>
							...
							<hr>
							<a href='http://www.magolinkpesapay.com/comment.php' >http://www.magolinkpesapay.com/comment.php</a>
							<hr> </td>
						  </tr>
						  <tr>
	...
	$safcom_payments = getAllSafcomPayments(STATUS_DONE);
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
			  ...
			  <tr>
                <td height="60" valign="bottom"><span class="style4">MPESA Log:  (complete transactions)</span></td>
			    </tr>
			  
			   <tr>
                <td height="90"><img src="images/spacer.gif" width="1" height="5"><img src="images/spacer.gif" width="1" height="1" border="0">
                  <fieldset>
                  <legend>MPESA Payments Log </legend>
				  ...
				  <table width="744" border="0">
                    ...
                    <tr>
                      ...
                      <td valign="top"><div align="right"> <a onClick="show_transactionForm(<?=$number; ?>);" class="hintanchor" style='color:#000000; cursor:pointer;' onmouseover="showhint('SEND TO:<hr>Name: <?=$name; ?><hr>MPESA Number: <?=$phone; ?><hr><?=$message; ?><hr>', this, event, '200px')">[?]</a></div></td>
