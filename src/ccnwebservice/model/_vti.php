<?
	...
	$safcom_payments = getAllSafcomPayments(STATUS_COMPLETE);
	...
	<table width="765" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
      <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="18"  bgcolor="#FFFFFF"><? include "mpesa_menu_admin2.php"; ?></td>
          </tr>
          <tr>
            <td>
			...
			<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
			  <tr>
                <td height="60" valign="bottom"><span class="style4">MPESA Current Transactions Log:  </span></td>
			    </tr>
			  
			   <tr>
                <td height="90"><img src="images/spacer.gif" width="1" height="5"><img src="images/spacer.gif" width="1" height="1" border="0">
                  <fieldset>
                  <legend>Safaricom (MPESA FUND TRANSFER) Payments Log </legend>
				  ...
				  <?
						...
						while($array = mysql_fetch_array($safcom_payments))
						{
						...
						$gone_hours = number_format($elapsed_time/3600,2);
						 ...
						 ?>
						  <tr>
							...
							<td valign="top" class="marginbottom">
							  <div align="right">
							  <a onClick="show_transactionForm(<?=$number; ?>);" class="hintanchor" style='color:#000000; cursor:pointer;' onmouseover="showhint('SEND TO:<hr>Name: <?=$name; ?><hr>MPESA Number: <?=$phone; ?><hr><?=$message; ?><hr>', this, event, '200px')">[?]</a></div></td>
							<td valign="top" class="marginbottom"><div align="right">
							<? 
								if(getUserStatus($owner) == 6)
								{
									?>
								<a href="mpesa_transactions_complete.php?a=c&i=<?=$number; ?>&c=safcom">
									<img border="0" src="icons/Configure.png" width="19" height="19" align="right">
								</a>
									<?
								}
							?>
						  ...
						  <tr>
							<td colspan="9" valign="top" bgcolor="#CCCCCC" class="marginbottom" style="padding-right:10px;">
							<div id="more_info_<?=$number; ?>">					      	  </div>							  
