 <?
   $distinctQuery2 = "select count(bill_id) as total_parking_bills from ".DATABASE.".customer_bills where service_account_type='3'";
 ...
 <script type="text/javascript">
		$(document).ready(
			function() {
				$("#table1").ingrid({ 
					url: 'remote_businesspermit_bills.php',
					height: 400,
					totalRecords: <?=$total_rows2;?>,
					pageNumber: 1,
					recordsPerPage: 0,
					colWidths: [90,75,120,215,100,100,120,100]
				});
			}
		); 
	</script>  
 ...
 <?
   $distinctQuery = "select * from ".DATABASE.".customer_bills where service_account_type='3' Order by bill_id ASC Limit 20";
