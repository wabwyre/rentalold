 ...
 set_layout("dt-layout.php", array(
	'pageSubTitle' => 'Incoming Compliance Transactions',
	'pageSubTitleText' => '',
	'pageBreadcrumbs' => array (
		array ( 'url'=>'index.php', 'text'=>'Home' ),
		array ( 'text'=>'Inbox' ),
		array ( 'text'=>'Incoming Compliance Transactions' )
	)
));
   $distinctQuery2 = "select * from ".DATABASE.".log_req WHERE transaction_code = 'COMPLIANCE'";
 ...
 <?
   $distinctQuery = "select * from ".DATABASE.".log_req WHERE transaction_code = 'COMPLIANCE' Order by header_id DESC Limit 20";
