...
set_layout("dt-layout.php", array(
  'pageSubTitle' => 'AFYAPOA COMMISSIONS',
  'pageSubTitleText' => '',
  'pageBreadcrumbs' => array (
    array ( 'url'=>'index.php', 'text'=>'Home' ),
    array ( 'text'=>'Reports' ),
    array ( 'text'=>'Commissions' )
  )
...
<div class="widget">
  <div class="widget-title"><h4><i class="icon-reorder"></i> All Commissions</h4></div>
  <div class="widget-body form">
 ...
 <?php
  ...
  if(isset($_POST['date_range'])){
   ...
   $distinctQuery = "SELECT ac.*, c.* "
           . "FROM afyapoa_commissions ac "
