 <?
   $distinctQuery2 = "select count(bill_id) as total_market_bills from ".DATABASE.".customer_bills where service_account_type='2'";
   $resultId2 = run_query($distinctQuery2);	
   $arraa = get_row_data($resultId2);
   $total_rows2 = $arraa['total_market_bills'];
 ?>
 ...
 <fieldset><legend class="table_fields">MARKET-BILLS</legend> 
   <table id="table1">
 <thead>
  <tr>
   <th>ID/PP#</th>
 ...
 <?
   $distinctQuery = "select * from ".DATABASE.".customer_bills where service_account_type='2' Order by bill_id DESC Limit 20";
