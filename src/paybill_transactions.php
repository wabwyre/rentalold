 ...
 set_layout("dt-layout.php", array(
	'pageSubTitle' => 'Incoming PayBill Transactions',
	'pageSubTitleText' => '',
	'pageBreadcrumbs' => array (
		array ( 'url'=>'index.php', 'text'=>'Home' ),
		array ( 'text'=>'Inbox' ),
		array ( 'text'=>'Incoming PayBill Transactions' )
	)
));
   $distinctQuery2 = "select * from ".DATABASE.".log_req WHERE transaction_code = 'PAYBILL'";
 ...
 <?
   $distinctQuery = "select * from ".DATABASE.".log_req WHERE transaction_code = 'PAYBILL' Order by header_id DESC Limit 20";
