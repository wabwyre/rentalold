 <?
  set_layout("dt-layout.php", array(
	'pageSubTitle' => 'Incoming BuyService Transactions',
	'pageSubTitleText' => '',
	'pageBreadcrumbs' => array (
		array ( 'url'=>'index.php', 'text'=>'Home' ),
		array ( 'text'=>'Inbox' ),
		array ( 'text'=>'Incoming BuyService Transactions' )
	)
));
   $distinctQuery2 = "select * from ".DATABASE.".log_req WHERE transaction_code = 'BUYSERVICE'";
 ...
 <?
   $distinctQuery = "select * from ".DATABASE.".log_req WHERE transaction_code = 'BUYSERVICE' Order by header_id DESC Limit 20";
