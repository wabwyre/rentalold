...
<!--begin form-->
   <div class="widget">
      <div class="widget-title"><h4><i class="icon-reorder"></i> Agent Profile { <span style="color: green;"><?=strtoupper($customer_name); ?></span> }</h4></div>
                                       ...
                                       <div class="row-fluid">
                                          <div class="span12 profile-info">
                                             ...
                                             <ul class="unstyled inline">
                                                <li><!-- <i class="icon-map-marker"></i> --> Agent# <?=$agent_id; ?></li>
