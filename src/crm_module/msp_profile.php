...
if (isset($_GET['msp'])){
   $msp=$_GET['msp'];
   //get the row
   $query="SELECT a.*, c.*, ct.*, ad.post_office_box, ad.postal_code, ad.premises, ad.street, ad.town, ad.county FROM afyapoa_msp a 
...
set_layout("dt-layout.php", array(
	...
	'pageBreadcrumbs' => array (
		array ( 'url'=>'#', 'text'=>'Home' ),
		array ( 'text'=>'CRM' ),
		array ( 'url'=>'?num=816', 'text'=>'All MSPs' ),
		array ( 'text'=>'MSP Profile' )
	)
));
...
<!--begin form-->
   <div class="widget">
      <div class="widget-title"><h4><i class="icon-reorder"></i>MSP Profile { <span style="color: green;"><?=strtoupper($customer_name); ?></span> }</h4></div>
		<div class="widget-body form">
                           <div class="tabbable tabbable-custom">
                              <ul class="nav nav-tabs">
                                 <li class="active"><a href="#tab_1_1" data-toggle="tab">Overview</a></li>
                                 <li><a href="#tab_1_2" data-toggle="tab">Visits</a></li>
                                 <li><a href="#tab_1_3" data-toggle="tab">Statistics</a></li>
                              ...
                              <div class="tab-content">
                                 <div class="tab-pane row-fluid active" id="tab_1_1">
                                    <!-- <ul class="unstyled profile-nav span3"> -->
                                       <!-- <li><img src="<?=$image_path; ?>" alt="" /> <a href="#" class="profile-edit">edit</a></li> -->
                                    ...
                                    <div class="span12">
                                       <div class="row-fluid">
                                          <div class="span12 profile-info">
                                             ...
                                             <ul class="unstyled inline">
                                                <li><!-- <i class="icon-map-marker"></i> --> MSP# <?=$agent_id; ?></li>
                                                <li><!-- <i class="icon-calendar"></i> --> D.O.B <?=$dob; ?></li>
                                       ...
                                       <div class="tabbable tabbable-custom tabbable-custom-profile">
                                          <ul class="nav nav-tabs">
                                             <!-- <li class="active"><a href="#tab_1_11" data-toggle="tab">Registrations</a></li> -->
                                             <!-- <li class=""><a href="#tab_1_22" data-toggle="tab">Commissions</a></li> -->
                                          </ul>
                                          <!-- <div class="tab-content"> -->
