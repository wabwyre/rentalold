...
if (isset($_GET['customer'])){
   ...
   //get the row
   $query="SELECT a.*, c.*, ct.*, ad.post_office_box, ad.postal_code, ad.premises, ad.street, ad.town, ad.county FROM afyapoa_association a 
...
set_layout("dt-layout.php", array(
	...
	'pageBreadcrumbs' => array (
		array ( 'url'=>'#', 'text'=>'Home' ),
		array ( 'text'=>'CRM' ),
		array ( 'url'=>'?num=814', 'text'=>'All Associations' ),
		array ( 'text'=>'Association Profile' )
	)
));
...
<!--begin form-->
   <div class="widget">
      <div class="widget-title"><h4><i class="icon-reorder"></i> Association Profile { <span style="color: green;"><?=strtoupper($customer_name); ?></span> }</h4></div>
                                 ...
                                 <div class="tab-pane row-fluid active" id="tab_1_1">
                                    ...
                                    <div class="span9">
                                       ...
                                       <div class="tabbable tabbable-custom tabbable-custom-profile">
                                          <ul class="nav nav-tabs">
                                             <li class="active"><a href="#tab_1_11" data-toggle="tab">Customers List</a></li>
                                          ...
                                          <div class="tab-content">
                                             <div class="tab-pane active" id="tab_1_11">
                                                <div class="portlet-body" style="display: block;">
                                                   <? include 'assoc_customers_list.php'; ?>
                                                </div>
                                             </div>
                                             <!--tab-pane-->
