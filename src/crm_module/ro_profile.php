...
set_layout("dt-layout.php", array(
	...
	'pageBreadcrumbs' => array (
		array ( 'url'=>'#', 'text'=>'Home' ),
		array ( 'text'=>'CRM' ),
		array ( 'url'=>'?num=812', 'text'=>'All ROs' ),
		array ( 'text'=>'RO Profile' )
	)
));
...
<!--begin form-->
   <div class="widget">
      <div class="widget-title"><h4><i class="icon-reorder"></i> RO Profile { <span style="color: green;"><?=strtoupper($customer_name); ?></span> }</h4></div>
