...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#cdetails").validate({
			...
			messages: {
				nationalidnumber: "Please enter customer's National ID",
...
<fieldset><legend class="table_fields"><?=$_GET['nme']?></legend>
    <form name="cdetails" id="cdetails" method="post" action="">
     <table>
         <tr>
             <td><label class="packlabel">National ID Number</label></td>
             <td><input type="text" name="nationalidnumber" value=""  class="packinput"></td>
