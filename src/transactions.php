<?
 set_layout("dt-layout.php", array(
	'pageSubTitle' => 'Incoming Requests',
	'pageSubTitleText' => '',
	'pageBreadcrumbs' => array (
		array ( 'url'=>'index.php', 'text'=>'Home' ),
		array ( 'text'=>'Inbox' ),
		array ( 'text'=>'Incoming Requests' )
	)
));
   $distinctQuery2 = "select * from ".DATABASE.".log_req";
 ...
 <?
   $distinctQuery = "select * from ".DATABASE.".log_req Order by header_id DESC Limit 20";
